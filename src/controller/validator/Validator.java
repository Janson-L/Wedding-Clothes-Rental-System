...
public static Double validate (String field, String value, boolean required,boolean hasMinimum, boolean hasMaximum, double minimum, double maximum) 
		throws RequiredFieldException, MaximumLengthException, InvalidNumberException, MinimumNumberException, MaximumNumberException
{
	if(required&&(value==null || value.trim().isEmpty())){
		throw new RequiredFieldException(field);
	}
	...
	{
		throw new MaximumNumberException(field,minimum);
	}
	return number;
}
